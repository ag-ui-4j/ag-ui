...
/**
 * A system message, typically used to set context or behaviour for the agent.
 *
 ...
 */
public record SystemMessage(String id, String content, String name) implements Message {
    ...
    /**
     * Creates a system message without a name.
     *
